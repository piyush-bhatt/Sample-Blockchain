        ...
        while waiting_for_input:
            ...
            if user_choice == 1:
                if self.wallet.public_key is not None:
                    ...
                    if self.blockchain.add_transaction(recipient, self.wallet.public_key, signature, amount=amount) is not None:
                ...
                if Verification.verify_transactions(self.blockchain.get_open_transactions(), self.blockchain.get_wallet_balance):
            ...
            print(f"{self.wallet.public_key} balance: {self.blockchain.get_wallet_balance():6.2f}")
        print("Done")
